...
import com.example.sstdoble.controlador.CrearActividades;
...
public class CreaActividades extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviarEvidencia.setOnClickListener(v -> {
            ...
            CrearActividades actividad = new CrearActividades(0, usuario, nombreActividad, fecha, descripcion, urlImagen);
        ...
        findViewById(R.id.btnEnviarEvidencia).setOnLongClickListener(v -> {
